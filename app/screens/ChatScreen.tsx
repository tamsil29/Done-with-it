...
function ChatScreen() {
  ...
  const { data, request: getConvos, isLoading} = useApi(messagesApi.getMessages);
  ...
  const handleSend = async () => {
    ...
    const result = await postMessage.request({conversationId: conversation?._id, message: message})
